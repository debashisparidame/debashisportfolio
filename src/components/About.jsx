      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-Ovo">
            I am an experienced web developer skilled in both frontend and
            backend development. I specialize in creating responsive websites
            using modern technologies and best practices to deliver
